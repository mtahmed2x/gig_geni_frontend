...
export const employeeBenefits = [
  {
    ...
    description:
      "Demonstrate your abilities through real challenges, not just resumes",
  ...
  },
  {
    ...
    description:
      "Bypass lengthy interview processes with performance-based selection",
...
export const mockCompetitions: Competition[] = [
  {
    ...
    description:
      "Build a complete e-commerce application using React, Node.js, and MongoDB.",
  ...
  },
  {
    ...
    description:
      "Create and execute a comprehensive digital marketing strategy for a startup.",
    skillsTested: [
  ...
  },
  {
    ...
    description:
      "Demonstrate your sales skills through role-play scenarios and real client pitches.",
    skillsTested: [
      "Cold Calling",
      "Negotiation",
      "CRM Software",
...
export const flowSteps = [
  {
    ...
    description:
      "Answer domain-specific questions and situational challenges to qualify",
    details: [
  ...
  },
  {
    ...
    description:
      "Complete real-world projects that showcase your practical abilities",
    details: [
      "Coding challenges",
  ...
  },
  {
    ...
    description:
      "Present your solution to industry experts and potential employers",
    details: [
      "Live demonstrations",
      "Q&A sessions",
      "Peer interactions",
  ...
  },
  {
    ...
    description:
      "Get scored, ranked, and potentially hired based on your performance",
    details: [
...
export const upcomingFeatures = [
  {
    ...
    title: "Mobile App",
    description:
      "Complete competitions on-the-go with native iOS and Android apps",
    comingSoon: "Q1 2026",
    color: "from-blue-500 to-blue-600",
    benefits: [
      "Offline mode",
  ...
  },
  {
    ...
    title: "AI Matching",
    description:
      "Smart algorithms that match candidates with perfect opportunities",
    comingSoon: "Q2 2025",
    color: "from-purple-500 to-purple-600",
    benefits: [
      "Skill analysis",
  ...
  },
  {
    ...
    description:
      "Stay updated with instant alerts for competitions and results",
    comingSoon: "Q1 2025",
    color: "from-[#FC5602] to-[#FF7B02]",
    benefits: [
      "Instant alerts",
    ...
    competitionHistory: [
      {
        ...
        roundScores: [
          {
            roundNumber: 1,
            roundType: "User Research",
            score: 92,
            maxScore: 100,
            completedDate: new Date("2024-03-07"),
          },
          {
            roundNumber: 2,
            roundType: "Wireframing",
            score: 88,
            maxScore: 100,
    ...
    competitionHistory: [
      {
        ...
        roundScores: [
          ...
          {
            roundNumber: 3,
            roundType: "Strategy Presentation",
            score: 89,
            maxScore: 100,
    ...
    competitionHistory: [
      {
        ...
        roundScores: [
          ...
          },
          {
            ...
            score: 89,
            maxScore: 100,
            completedDate: new Date("2024-05-17"),
          },
          {
            roundNumber: 3,
            roundType: "Client Presentation",
            score: 96,
            maxScore: 100,
